var finalImage = require('users/Jhonnattan_Oliveira/Mestrado:modulos_Sentinel2/1 - calculo_indices_espectrais');
...
Export.image.toAsset({
  ...
  assetId: 'users/Jhonnattan_Oliveira/CG-MS/CG_5pca10',
  region: geometry,
  scale: scale,
  maxPixels: 1e10
});
...
var pcaImported = ee.Image('users/Jhonnattan_Oliveira/CG-MS/CG_5pca10');
