var imageModule = require('users/Jhonnattan_Oliveira/Mestrado:modulos_Sentinel2/2 - analise_pca');

var image = imageModule.mosaic2.select('NDWI','B12','NDVI','B1','B11','B4','B2','B8A','B9','B7','B3',
'Gradiente_NDVI','B8_savg','B5','B8','pc2','B6','B8_dvar','pc3','B8_shade','B8_diss','pc4','B8_inertia',
'pc1','pc5','B8_svar','B8_idm','B8_contrast','B8_prom');
...
var chart = ui.Chart.array.values({
  ...
  title: 'Band Importance (Pixel-Based Approach, Sentinel 2)',
  titleTextStyle: {
    bold: true,
    fontSize: 16,
    italic: false
...
Export.image.toDrive({
  ...
  description: 'Sentinel2_Class_Pixel_CG',
