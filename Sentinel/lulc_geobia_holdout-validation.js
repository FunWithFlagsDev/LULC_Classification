...
var image = imageModule.mosaic3.select('B12_mean','NDWI_mean','NDVI_mean','B2_mean','Gradiente_NDVI_mean',
'B11_mean','B1_mean','B4_mean','B5_mean','B3_mean','B9_mean','pc2_mean','B8A_mean','B8_savg_mean','B6_mean',
'B8_mean','B8_corr_mean','B7_mean','pc4_mean','B8_shade_mean','B8_idm_mean','pc5_mean','pc3_mean','B8_dvar_mean',
'B8_diss_mean','pc1_mean','B8_inertia_mean');
...
var chart = ui.Chart.array.values({
  ...
  title: 'Band Importance (GEOBIA Approach, Sentinel 2)',
  titleTextStyle: {
    bold: true,
    fontSize: 16,
    italic: false
...
Export.image.toDrive({
  ...
  description: 'Sentinel2_Class_Geobia_CG',
